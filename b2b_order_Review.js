...
import getCartItemsById from '@salesforce/apex/B2B_InventoryController.getCartItemsById';
import getContactPointAddress from '@salesforce/apex/B2B_InventoryController.getContactPointAddress';
import getOrderProductSummaryById from '@salesforce/apex/B2B_InventoryController.getOrderProductSummaryById';
import communityId from '@salesforce/community/Id';

export default class B2b_order_Review extends LightningElement {
    currentCartId;
